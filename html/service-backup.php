...
<div class="form-style-2">
  ...
  <form action="service.php" method="post">
    ...
    <label><span>&nbsp;</span>
      <input type="button" name="openSub2" class="openSub2" value="Request" data-toggle="modal" data-target="#modelWindowSub"/>
    </label>
  </form>
</div>
    ...
    <div class="modal-content animate">
      ...
      <div class="modal-body">
        <label for="displayDate">RequestID
          <input type="text" name="input-field" id="requestInput" value="R001" readonly>
        </label>

        <label for="updateStatus">Status:
          <input type="text" name="input-field" id="statusInput" value="pending" readonly>
        </label>

        <label for="updateCode">Service Code:
          <input type="text" name="input-field" id="codeInput" value="A4531" readonly>
        </label>

        <label for="displayDate">Required Date:
          <input type="text" name="input-field" id="dateInput" value="10/10/2018" readonly>
        </label>

        <label for="displayTime">Required Time:
          <input type="text" name="input-field" id="timeInput" value="10:00 AM" readonly>
        </label>

        <label for="updateNotes">Notes:
          <textarea class="textarea-field" name="updateNotes" id="noteInput" rows="4" cols="50" readonly> Bring extra money </textarea>
        </label>
      </div>
      <div class="modal-footer">
        <button type="button" id="danger-btn" data-dismiss="modal" class="btn btn-sm">Close</button>
        <button type="button" id="danger-btn" data-dismiss="modal" class="btn btn-sm">Confirm</button>
      </div>
    </div>
  </div>
</div>
